...
class MainWindow(QMainWindow):
    ...
    def get_method_from_combo(self, combo):
        ...
        if index == 0:
            ...
            return DownloadMethod.SELECTIVE
        return DownloadMethod.GIT_CLONE
    ...
    def show_selective_download_dialog(self):
        ...
        if dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            if selected_paths:
                ...
                try:
                    task = self.downloader.create_download_task(repo_url, output_path, DownloadMethod.SELECTIVE, branch)
                    task.selected_paths = selected_paths
